...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Manuales Outsoursing</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Manuales</a></li>
                        <li class="breadcrumb-item active">Manuales Outsoursing</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Cargar Manuales Outsoursing</h5>
...
<script>
    $(document).ready(function() {
        APP.manualesOut.init();
    });

    Dropzone.autoDiscover = false;
    var myDropzone = new Dropzone("#my-dropzone", {
        url: base_url + "ManualesController/do_Upload/outsoursing",
        ...
        removedFiles: function(file) {
            ...
            $.ajax({
                type: "post",
                url: base_url + "ManualesController/Remove/outsoursing",
                data: {
                    file: name
                },
                dataType: "html"
